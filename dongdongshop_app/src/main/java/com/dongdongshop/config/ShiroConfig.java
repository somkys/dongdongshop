...
//        definition.addPathDefinition("/plugins/**","anon");//所有静态资源
//        definition.addPathDefinition("/person/toLogin","anon");//所有静态资源
//        definition.addPathDefinition("/person/login","anon");//所有静态资源
//        definition.addPathDefinition("/plugins/**","anon");//所有静态资源
